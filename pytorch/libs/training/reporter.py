    ...
    def _update(self):
        ...
        while True:
            try:
                ...
                self.bar.update(current_step, current_epoch=current_epoch, current_iter=current_iter,current_step=current_step,total_dur=total_dur,Num_sample=num_sample)
                real_snapshot = snapshot.pop("real")
                if self.board_writer is not None:
