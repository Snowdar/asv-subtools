...
import libs.egs.egs_feature_decompsition as egs
import libs.training.optim_fd as optim
import libs.training.lr_scheduler as learn_rate_scheduler
import libs.training.trainer_fd as trainer
...
parser.add_argument("--stage", type=int, default=3,
                    help="The stage to control the start of training epoch (default 3).\n"
                         ...
                         "    It's noted that the stage 2 only prepare the standard training egs. For the FD-AL traing, you should prepare additional labels according to your needs (e.g. speech speed labels, noise type labels). \n"
                         " The new egs_csv: utt-id:str  ark-path:str  start-position:int  end-position:int  class-lable:int type-label:int \n"
                         "    stage 3: training.\n"
...
egs_dir="exp/egs/mfcc_40_voxceleb1_train_two_label"


model_blueprint = "subtools/pytorch/model/snowdar-xvector-FD-AL.py"
model_dir = "exp/vox1_mfcc40_sequential_speed"
...
model_params = {
    ...
    "specaugment":False,
    "specaugment_params":{"frequency":0.2, "frame":0.2, "rows":2, "cols":2, "random_cols":True, "random_rows":True},
...
optimizer_params = {
    ...
    "beta2":0.999,
    "beta3":0.999,
    "weight_decay":1e-1,  # Should be large for decouped weight decay (1e-1   adamW) and small for L2 regularization (sgd, adam).
    "lookahead.k":5,
...
lr_scheduler_params = {
    ...
    "reduceP.factor":0.99999,  # scale of lr in every times.
    "reduceP.patience":1, 
...
if stage <= 3 <= endstage:
    ...
    trainer = trainer.GanDalAttTrainer(package)
...
if stage <= 4 <= endstage and utils.is_main_training():
    ...
    to_extracted_data = ["voxceleb1_train_and_ffmpeg_speed0.5-2.0","voxceleb1_enroll","voxceleb1_test_ffmpeg_speed1.0","voxceleb1_test_ffmpeg_speed1.1","voxceleb1_test_ffmpeg_speed1.2","voxceleb1_test_ffmpeg_speed0.8","voxceleb1_test_ffmpeg_speed0.9",
    "voxceleb1_test_ffmpeg_speed0.7","voxceleb1_test_ffmpeg_speed0.6","voxceleb1_test_ffmpeg_speed0.5","voxceleb1_test_ffmpeg_speed1.3","voxceleb1_test_ffmpeg_speed1.4","voxceleb1_test_ffmpeg_speed1.5",
    "voxceleb1_test_ffmpeg_speed1.6","voxceleb1_test_ffmpeg_speed1.7","voxceleb1_test_ffmpeg_speed1.8","voxceleb1_test_ffmpeg_speed1.9","voxceleb1_test_ffmpeg_speed2.0"]
