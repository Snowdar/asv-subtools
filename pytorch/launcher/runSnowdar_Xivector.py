...
model_params = {
    ...
    "pooling":"xi-postdist-softplus2", # statistics, lde, attentive, multi-head, multi-resolution, xi-postmean, xi-postdist,xi-postmean-softplus2,xi-postdist-softplus2
...
if stage <= 4 <= endstage and utils.is_main_training():
    ...
    to_extracted_data = ["voxceleb1_test", "voxceleb2_train"] # All dataset should be in data_root/prefix.
