...
if [ $# != 4 ]; then
  echo "Usage: subtools/kaldi/steps/train_map.sh <data> <lang> <ali-dir> <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/train_map.sh data/train_si84_female data/lang exp/tri3c_ali_si84_female exp/tri4b_female"
...
subtools/kaldi/utils/ln.pl $alidir/ali.*.gz $dir
