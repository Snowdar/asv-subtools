...
# 
# subtools/kaldi/steps/scoring/score_kaldi_wer.sh "$@"
# subtools/kaldi/steps/scoring/score_kaldi_cer.sh --stage 2 "$@"
#
  ...
  for wip in $(echo $word_ins_penalty | sed 's/,/ /g'); do
    ...
    if $decode_mbr ; then
      $cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring_kaldi/penalty_$wip/log/best_path.LMWT.log \
        ...
        ark:- ark,t:- \| \
        subtools/kaldi/utils/int2sym.pl -f 2- $symtab \| \
...
if [ $stage -le 3 ] ; then
  ...
  done | subtools/kaldi/utils/best_wer.sh  >& $dir/scoring_kaldi/best_cer || exit 1
  ...
  if $stats; then
    ...
    $cmd $dir/scoring_kaldi/log/stats1.cer.log \
      ...
      subtools/kaldi/utils/scoring/wer_per_utt_details.pl --special-symbol "'***'" \| tee $dir/scoring_kaldi/cer_details/per_utt \|\
       subtools/kaldi/utils/scoring/wer_per_spk_details.pl $data/utt2spk \> $dir/scoring_kaldi/cer_details/per_spk || exit 1;
