...
if [ $# != 4 ]; then
   ...
   echo "Usage: subtools/kaldi/steps/align_lvtln.sh [options] <data-dir> <lang-dir> <src-dir>  <align-dir>"
   echo " e.g.: subtools/kaldi/steps/align_lvtln.sh data/train data/lang exp/tri2c exp/tri2c_ali"
