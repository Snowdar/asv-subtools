...
if [ $# != 4 ]; then
   echo "Usage: subtools/kaldi/steps/make_index.sh [options] <kws-data-dir> <lang-dir> <decode-dir> <kws-dir>"
   ...
   echo "e.g.: subtools/kaldi/steps/make_index.sh data/kws data/lang exp/sgmm2_5a_mmi/decode/ exp/sgmm2_5a_mmi/decode/kws/"
   echo ""
