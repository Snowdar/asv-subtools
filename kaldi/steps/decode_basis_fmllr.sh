...
if [ $# != 3 ]; then
   echo "Usage: subtools/kaldi/steps/decode_basis_fmllr.sh [options] <graph-dir> <data-dir> <decode-dir>"
   echo " e.g.: subtools/kaldi/steps/decode_basis_fmllr.sh exp/tri2b/graph_tgpr data/train_si84 data/test_dev93 exp/tri2b/decode_dev93_tgpr"
