...
# See the script subtools/kaldi/steps/scoring/score_kaldi_cer.sh in case you need to evalutate CER
...
if [ $stage -le 1 ]; then
  ...
  done | subtools/kaldi/utils/best_wer.sh  >& $dir/scoring_kaldi/best_wer || exit 1
  ...
  if $stats; then
    ...
    $cmd $dir/scoring_kaldi/log/stats1.log \
      ...
      subtools/kaldi/utils/scoring/wer_per_utt_details.pl --special-symbol "'***'" \| tee $dir/scoring_kaldi/wer_details/per_utt \|\
       subtools/kaldi/utils/scoring/wer_per_spk_details.pl $data/utt2spk \> $dir/scoring_kaldi/wer_details/per_spk || exit 1;
