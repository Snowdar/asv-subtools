...
if [ $# != 4 ]; then
   echo "usage: subtools/kaldi/steps/align_sgmm2.sh <data-dir> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  subtools/kaldi/steps/align_sgmm2.sh --transform-dir exp/tri3b data/train data/lang \\"
