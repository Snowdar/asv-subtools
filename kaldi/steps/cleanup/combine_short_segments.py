...
def GetArgs():
    ...
    **Warning, this script is deprecated.  Please use subtools/kaldi/utils/data/combine_short_segments.sh**
...
def Main():
    print("""subtools/kaldi/steps/cleanup/combine_short_segments.py: warning: this script is deprecated and will be removed.
          Please use subtools/kaldi/utils/data/combine_short_segments.sh""", file = sys.stderr)
    args = GetArgs()
    ...
    RunKaldiCommand("subtools/kaldi/utils/data/get_utt2dur.sh {0}".format(args.input_data_dir))

    CombineSegments(args.input_data_dir, args.output_data_dir, args.minimum_duration)

    RunKaldiCommand("subtools/kaldi/utils/utt2spk_to_spk2utt.pl {od}/utt2spk > {od}/spk2utt".format(od = args.output_data_dir))
    ...
    RunKaldiCommand("subtools/kaldi/utils/fix_data_dir.sh {0}".format(args.output_data_dir))
