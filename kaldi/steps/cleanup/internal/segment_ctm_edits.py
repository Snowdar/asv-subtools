...
parser = argparse.ArgumentParser(
    ...
    "subtools/kaldi/steps/cleanup/internal/get_ctm_edits.py, subtools/kaldi/steps/cleanup/internal/modify_ctm_edits.py and "
    "subtools/kaldi/steps/cleanup/internal/taint_ctm_edits.py.",
...
parser.add_argument("non_scored_words_in", metavar = "<non-scored-words-file>",
                    ...
                    "one per line. See subtools/kaldi/steps/cleanup/internal/get_nonscored_words.py.")
