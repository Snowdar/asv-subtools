...
parser = argparse.ArgumentParser(
    ...
    "is output by subtools/kaldi/steps/cleanup/internal/get_ctm_edits.py, to allow insertions, deletions and "
...
parser.add_argument("non_scored_words_in", metavar = "<non-scored-words-file>",
                    ...
                    "one per line. See subtools/kaldi/steps/cleanup/get_nonscored_words.py.")
