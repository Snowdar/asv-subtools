...
# by subtools/kaldi/steps/cleanup/debug_lexicon.sh.  This input file has lines of the form:
...
def GetArgs():
    parser = argparse.ArgumentParser(description = "Accumulate pronounciation statistics from "
                                     ...
                                     epilog = "See subtools/kaldi/steps/cleanup/debug_lexicon.sh for example")
