...
def get_args():
    parser = argparse.ArgumentParser(
        ...
        subtools/kaldi/steps/cleanup/internal/get_ctm_edits.py,
        subtools/kaldi/steps/cleanup/internal/modify_ctm_edits.py and
    ...
    parser.add_argument("non_scored_words_in",
                        ...
                        subtools/kaldi/steps/cleanup/internal/get_nonscored_words.py.""")
