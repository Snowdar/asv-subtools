...
# This script is similar to subtools/kaldi/steps/cleanup/decode_segmentation.sh, but 
...
. subtools/kaldi/utils/parse_options.sh || exit 1;
...
if [ $# -ne 3 ]; then
   ...
   echo "This will normally be obtained by subtools/kaldi/steps/cleanup/make_biased_lm_graphs.sh."
   echo ""
...
if [ ! -z "$online_ivector_dir" ]; then
  subtools/kaldi/steps/nnet2/check_ivectors_compatible.sh $srcdir $online_ivector_dir || exit 1
  extra_files="$online_ivector_dir/ivector_online.scp $online_ivector_dir/ivector_period"
fi

subtools/kaldi/utils/lang/check_phones_compatible.sh $graph_dir/phones.txt $srcdir/phones.txt || exit 1
...
subtools/kaldi/utils/filter_scps.pl --no-warn -f 1 JOB=1:$nj \
