...
if [ $# -ne 4 ]; then
  ...
  echo "segmentation. It first calls subtools/kaldi/steps/cleanup/make_utterance_graph.sh to"
...
subtools/kaldi/utils/split_scp.pl $data/text.orig $split_texts

$cmd JOB=1:$nj $graph_dir/log/make_utterance_graph.JOB.log \
  subtools/kaldi/steps/cleanup/make_utterance_graph.sh --cleanup $cleanup \
