...
if [ $# -ne 5 ]; then
  ...
  echo "                              # Please run subtools/kaldi/steps/cleanup/internal/segment_ctm_edits.py"
  echo "                              # without arguments to see allowed options."
  echo "  --graph-opts 'opts'         # Additional options to make_biased_lm_graphs.sh."
  echo "                              # Please run subtools/kaldi/steps/cleanup/make_biased_lm_graphs.sh"
  echo "                              # without arguments to see allowed options."
...
if [ $stage -le 3 ]; then
  ...
  subtools/kaldi/steps/cleanup/lattice_oracle_align.sh \
