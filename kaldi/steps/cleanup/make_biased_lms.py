...
def ProcessGroupOfLines(group_of_lines):
    ...
    try:
        command = "subtools/kaldi/steps/cleanup/internal/make_one_biased_lm.py " + args.lm_opts
...
# (echo utt1 6 7 8 4; echo utt2 7 8 9; echo utt3 7 8) | subtools/kaldi/steps/cleanup/make_biased_lms.py --lm-opts='--word-disambig-symbol=1000 --top-words=top_words.txt' foo; cat foo

# (echo utt1 6 7 8 4; echo utt2 7 8 9; echo utt3 7 8) | subtools/kaldi/steps/cleanup/make_biased_lms.py --min-words-per-graph=4 --lm-opts='--word-disambig-symbol=1000 --top-words=top_words.txt' foo; cat foo
