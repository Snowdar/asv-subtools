...
if [ $# -ne 3 ]; then
  ...
  echo "created by subtools/kaldi/steps/cleanup/split_long_utterance.sh, works out a new"
...
# Removes the overlapping region (in subtools/kaldi/utils/split_long_utterance.sh we create
...
subtools/kaldi/steps/cleanup/create_segments_from_ctm.pl \
...
subtools/kaldi/utils/utt2spk_to_spk2utt.pl $new_data_dir/utt2spk > $new_data_dir/spk2utt

subtools/kaldi/utils/fix_data_dir.sh $new_data_dir
