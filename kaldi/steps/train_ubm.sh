...
if [ $# != 5 ]; then
  echo "Usage: subtools/kaldi/steps/train_ubm.sh <num-gauss> <data> <lang> <ali-dir> <exp>"
  echo " e.g.: subtools/kaldi/steps/train_ubm.sh 400 data/train_si84 data/lang exp/tri2b_ali_si84 exp/ubm3c"
