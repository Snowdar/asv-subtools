...
if [ $# != 4 ]; then
   echo "usage: subtools/kaldi/steps/align_fmllr_lats.sh <data-dir> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  subtools/kaldi/steps/align_fmllr_lats.sh data/train data/lang exp/tri1 exp/tri1_lats"
