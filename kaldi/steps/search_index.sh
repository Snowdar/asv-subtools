...
if [ $# != 2 ]; then
   echo "Usage: subtools/kaldi/steps/search_index.sh [options] <kws-data-dir> <kws-dir>"
   echo " e.g.: subtools/kaldi/steps/search_index.sh data/kws exp/sgmm2_5a_mmi/decode/kws/"
   echo ""
