...
# subtools/kaldi/steps/make_phone_graph.sh data/train_100k_nodup/ data/lang exp/tri2_ali_100k_nodup/ exp/tri2
...
# Uses SRILM.
# See also subtools/kaldi/utils/lang/make_phone_bigram_lm.sh.
...
if [ $stage -le 0 ]; then
  ...
  gunzip -c $alidir/ali.*gz | ali-to-phones $alidir/final.mdl ark:- ark,t:- | \
    ...
    subtools/kaldi/utils/int2sym.pl $lang/phones.txt > $dir/phone_graph/train_phones.txt
fi
