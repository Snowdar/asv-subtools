...
if [ $# != 6 ]; then
  echo "Usage: subtools/kaldi/steps/train_quick.sh <num-leaves> <num-gauss> <data> <lang> <ali-dir> <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/train_quick.sh 2500 15000 data/train_si284 data/lang exp/tri3c_ali_si284 exp/tri4b"
