...
if [ $# != 4 ]; then
  echo "Usage: subtools/kaldi/steps/tandem/train_mono.sh [options] <data1-dir> <data2-dir> <lang-dir> <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/tandem/train_mono.sh {mfcc,bottleneck}/data/train.1k data/lang exp/mono"
