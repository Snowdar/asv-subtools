...
if [ $# -ne 4 ]; then
  echo "Usage: subtools/kaldi/steps/tandem/decode_sgmm2.sh [options] <graph-dir> <data-dir1> <data-dir2> <decode-dir>"
  echo " e.g.: subtools/kaldi/steps/tandem/decode_sgmm2.sh --transform-dir exp/tri3b/decode_dev93_tgpr \\"
