...
if [ $# != 5 ]; then
   echo "usage: subtools/kaldi/steps/tandem/align_sgmm2.sh <data-dir1> <data-dir2> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  subtools/kaldi/steps/tandem/align_sgmm2.sh --transform-dir exp/tri3b {mfcc,bottleneck}/data/train data/lang \\"
...
if $use_graphs; then
  ...
  if [ $stage -le 0 ]; then
    ...
    tra="ark:subtools/kaldi/utils/sym2int.pl --map-oov $oov -f 2- $lang/words.txt $sdata1/JOB/text|";
