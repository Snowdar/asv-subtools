...
if [ $# != 5 ]; then
   echo "usage: subtools/kaldi/steps/tandem/align_si.sh <data1-dir> <data2-dir> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  subtools/kaldi/steps/tandem/align_si.sh {mfcc,bottleneck}/data/train data/lang exp/tri1 exp/tri1_ali"
