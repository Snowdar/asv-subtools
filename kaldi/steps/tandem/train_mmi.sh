...
if [ $# -ne 6 ]; then
  echo "Usage: subtools/kaldi/steps/train_tandem_mmi.sh <data1> <data2> <lang> <ali> <denlats> <exp>"
  echo " e.g.: subtools/kaldi/steps/train_tandem_mmi.sh {mfcc,bottleneck}/data/train_si84 data/lang exp/tri2b_ali_si84 exp/tri2b_denlats_si84 exp/tri2b_mmi"
