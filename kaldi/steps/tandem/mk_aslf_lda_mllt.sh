...
if [ $# != 4 ]; then
   echo "Usage: subtools/kaldi/steps/tandem/mk_aslf_lda_mllt.sh [options] <graph-dir> <data1-dir> <data2-dir> <decode-dir>"
   echo " e.g.: subtools/kaldi/steps/tandem/mk_aslf_lda_mllt.sh exp/tri2b/graph {mfcc,bottleneck}/data/test_dev93 exp/tri2b/decode_dev93"
...
$cmd JOB=1:$nj $dir/log/rescore.slf.JOB.log \
  ...
  subtools/kaldi/utils/int2sym.pl -f 3 $graphdir/words.txt \| \
  subtools/kaldi/utils/convert_slf.pl - $dir/slf
