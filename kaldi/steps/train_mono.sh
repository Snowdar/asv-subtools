...
if [ $# != 3 ]; then
  echo "Usage: subtools/kaldi/steps/train_mono.sh [options] <data-dir> <lang-dir> <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/train_mono.sh data/train.1k data/lang exp/mono"
