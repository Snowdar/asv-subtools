...
if [ $# != 3 ]; then
   echo "Usage: subtools/kaldi/steps/get_fmllr_basis.sh [options] <data-dir> <lang-dir> <exp-dir>"
   echo " e.g.: subtools/kaldi/steps/decode_basis_fmllr.sh data/train_si84 data/lang exp/tri3b/"
...
subtools/kaldi/utils/lang/check_phones_compatible.sh $lang/phones.txt $dir/phones.txt || exit 1;
