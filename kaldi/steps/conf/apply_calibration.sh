...
if [ $stage -le 0 ]; then
  ...
  rm $dir/*.ctm
  cat $dir/ctm | subtools/kaldi/utils/sym2int.pl -f 5 $lang/words.txt >$dir/ctm_int
fi
...
if [ $stage -le 2 ]; then
  subtools/kaldi/steps/conf/prepare_calibration_data.py --conf-feats $dir/forward_feats.ark \
