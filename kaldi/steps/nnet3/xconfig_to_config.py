...
# test:
# (echo 'input dim=40 name=input'; echo 'output name=output input=Append(-1,0,1)')  >xconfig; subtools/kaldi/steps/nnet3/xconfig_to_config.py --xconfig-file=xconfig --config-file-out=foo
