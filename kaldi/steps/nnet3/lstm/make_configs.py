...
nodes = imp.load_source('nodes', 'subtools/kaldi/steps/nnet3/components.py')
...
def GetArgs():
    ...
    parser = argparse.ArgumentParser(description="Writes config files and variables "
                                     ...
                                     epilog="See subtools/kaldi/steps/nnet3/lstm/train.sh for example.")
...
def ProcessSpliceIndexes(config_dir, splice_indexes, label_delay, num_lstm_layers):
    ...
    # write the files used by other scripts like subtools/kaldi/steps/nnet3/get_egs.sh
