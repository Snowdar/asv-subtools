...
if [ $stage -le -5 ]; then
  ...
  subtools/kaldi/steps/nnet3/lstm/make_configs.py  "${config_extra_opts[@]}" \
...
while [ $x -lt $num_iters ]; do
  ...
  if [ $x -ge 0 ] && [ $stage -le $x ]; then
    ...
    models_to_average=$(subtools/kaldi/steps/nnet3/get_successful_models.py $this_num_jobs $dir/log/train.$x.%.log)
    nnets_list=
