...
# This script is similar to subtools/kaldi/steps/nnet3/get_egs.sh but used
...
awk '{print $1}' $data/utt2spk | subtools/kaldi/utils/shuffle_list.pl 2>/dev/null | head -$num_utts_subset_valid | sort \
    > $dir/valid_uttlist
...
awk '{print $1}' $data/utt2spk | subtools/kaldi/utils/filter_scp.pl --exclude $dir/valid_uttlist | \
   subtools/kaldi/utils/shuffle_list.pl 2>/dev/null | head -$num_utts_subset_train | sort > $dir/train_subset_uttlist
...
for n in `seq $nj`; do
  subtools/kaldi/utils/filter_scp.pl $sdata/$n/utt2spk $targets_scp > $dir/targets.$n.scp
done
...
case $target_type in
  "dense")
    ...
    targets="scp,s,cs:subtools/kaldi/utils/filter_scp.pl --exclude $dir/valid_uttlist $targets_scp_split |"
    valid_targets="scp,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/valid_uttlist $targets_scp |"
    train_subset_targets="scp,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/train_subset_uttlist $targets_scp |"
    ;;
  "sparse")
    get_egs_program="nnet3-get-egs --num-pdfs=$num_targets"
    targets="ark,s,cs:subtools/kaldi/utils/filter_scp.pl --exclude $dir/valid_uttlist $targets_scp_split | ali-to-post scp:- ark:- |"
    valid_targets="ark,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/valid_uttlist $targets_scp | ali-to-post scp:- ark:- |"
    train_subset_targets="ark,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/train_subset_uttlist $targets_scp | ali-to-post scp:- ark:- |"
    ;;
  default)
