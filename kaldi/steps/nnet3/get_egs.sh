...
awk '{print $1}' $data/utt2spk | subtools/kaldi/utils/shuffle_list.pl 2>/dev/null | head -$num_utts_subset \
    > $dir/valid_uttlist
...
if [ -e $dir/storage ]; then
  ...
  subtools/kaldi/utils/create_data_link.pl $(for x in $(seq $num_archives); do echo $dir/egs.$x.ark; done)
  for x in $(seq $num_archives_intermediate); do
    subtools/kaldi/utils/create_data_link.pl $(for y in $(seq $nj); do echo $dir/egs_orig.$y.$x.ark; done)
  done
fi
...
if [ $stage -le 3 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    subtools/kaldi/utils/filter_scp.pl $dir/valid_uttlist $dir/ali_special.scp \| \
  ...
  $cmd $dir/log/create_train_subset.log \
    subtools/kaldi/utils/filter_scp.pl $dir/train_subset_uttlist $dir/ali_special.scp \| \
    ali-to-pdf $alidir/final.mdl scp:- ark:- \| \
    ali-to-post ark:- ark:- \| \
    nnet3-get-egs --num-pdfs=$num_pdfs --frame-subsampling-factor=$frame_subsampling_factor \
