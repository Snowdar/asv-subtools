...
if [ $# != 4 ]; then
  echo "Usage: subtools/kaldi/steps/nnet3/make_denlats.sh [options] <data-dir> <lang-dir> <src-dir> <exp-dir>"
  echo "  e.g.: subtools/kaldi/steps/nnet3/make_denlats.sh data/train data/lang exp/nnet4 exp/nnet4_denlats"
  echo ""
