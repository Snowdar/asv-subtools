...
if [ ! -z "$online_ivector_dir" ];then
  subtools/kaldi/steps/nnet2/check_ivectors_compatible.sh $model_dir $online_ivector_dir || exit 1;
  ivector_period=$(cat $online_ivector_dir/ivector_period) || exit 1;
  ivector_feats="scp:subtools/kaldi/utils/filter_scp.pl $sdata/JOB/utt2spk $online_ivector_dir/ivector_online.scp |"
...
if [ $stage -le 1 ] && $remove_word_position_dependency; then
  ...
  subtools/kaldi/utils/lang/get_word_position_phone_map.pl $lang $dir
else
...
if [ $stage -le 1 ]; then
  ...
  if $remove_word_position_dependency; then
    ...
    subtools/kaldi/utils/apply_map.pl -f 1 $dir/phone_map.int <$dir/combined_info.txt > $dir/temp.txt
