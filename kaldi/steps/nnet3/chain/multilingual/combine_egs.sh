...
# This script is similar to subtools/kaldi/steps/nnet3/multilingual/combine_egs.sh, but 
...
if [ $stage -le 0 ]; then
  ...
  $cmd $megs_dir/log/allocate_multilingual_examples_train.log \
    subtools/kaldi/steps/nnet3/multilingual/allocate_multilingual_examples.py $egs_opt \
