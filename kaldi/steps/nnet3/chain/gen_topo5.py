...
parser = argparse.ArgumentParser(description="Usage: subtools/kaldi/steps/nnet3/chain/gen_topo.py "
                                             "<colon-separated-nonsilence-phones> <colon-separated-silence-phones>"
                                             "e.g.:  subtools/kaldi/steps/nnet3/chain/gen_topo.pl 4:5:6:7:8:9:10 1:2:3\n",
