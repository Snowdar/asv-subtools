...
""" This script is based on subtools/kaldi/steps/nnet3/chain/train.sh
"""
...
def train(args, run_opts):
    ...
    common_lib.execute_command("subtools/kaldi/utils/split_data.sh {0} {1}"
    ...
    common_lib.execute_command("subtools/kaldi/steps/info/chain_dir_info.pl "
                               "{0}".format(args.dir))
