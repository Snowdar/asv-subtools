...
# This script is similar to subtools/kaldi/steps/nnet3/chain/build_tree.sh but supports 
...
if [ $# -lt 5 ]; then
  echo "Usage: subtools/kaldi/steps/nnet3/chain/build_tree_multiple_sources.sh <#leaves> <lang> <data1> <ali-dir1> [<data2> <ali-dir2> ... <data> <ali-dirN>] <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/nnet3/chain/build_tree_multiple_sources.sh 15000 data/lang data/train_sup exp/tri3_ali data/train_unsup exp/tri3/best_path_train_unsup exp/tree_semi"
...
subtools/kaldi/utils/combine_data.sh $data ${datadirs[@]} || exit 1
...
if [ $stage -le -1 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/copy_alignments.JOB.log \
    copy-int-vector "scp:subtools/kaldi/utils/filter_scp.pl $data/split$nj/JOB/utt2spk $dir/ali.scp |" \
