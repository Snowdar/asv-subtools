...
""" This script does flat-start chain training and is based on
    subtools/kaldi/steps/nnet3/chain/train.py.
"""
...
def train(args, run_opts):
    ...
    common_lib.execute_command("subtools/kaldi/utils/split_data.sh {0} {1}".format(
    ...
    if (args.stage <= -3) and args.egs_dir is None:
        ...
        common_lib.execute_command(
            """subtools/kaldi/steps/nnet3/chain/e2e/get_egs_e2e.sh {egs_opts} \
                    --cmd "{command}" \
                    --cmvn-opts "{cmvn_opts}" \
