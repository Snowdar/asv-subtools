...
frame_shift=$(subtools/kaldi/utils/data/get_frame_shift.sh $data) || exit 1
...
if [ -f $data/utt2uniq ]; then
  ...
  subtools/kaldi/utils/utt2spk_to_spk2utt.pl $data/utt2uniq 2>/dev/null | \
      subtools/kaldi/utils/shuffle_list.pl 2>/dev/null | \
...
if [ $stage -le 2 ]; then
  ...
  (
    ...
    $cmd $dir/log/create_valid_subset.log \
      subtools/kaldi/utils/filter_scp.pl $dir/valid_uttlist $dir/lat_special.scp \| \
    ...
    $cmd $dir/log/create_train_subset.log \
      subtools/kaldi/utils/filter_scp.pl $dir/train_subset_uttlist $dir/lat_special.scp \| \
      lattice-align-phones --replace-output-symbols=true $latdir/final.mdl scp:- ark:- \| \
