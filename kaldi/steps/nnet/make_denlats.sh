...
if [ $# != 4 ]; then
   echo "Usage: subtools/kaldi/steps/$0 [options] <data-dir> <lang-dir> <src-dir> <exp-dir>"
   echo "  e.g.: subtools/kaldi/steps/$0 data/train data/lang exp/tri1 exp/tri1_denlats"
