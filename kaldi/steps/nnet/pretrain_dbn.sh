...
# shuffle the list,
subtools/kaldi/utils/shuffle_list.pl --srand 777 <$dir/train_sorted.scp >$dir/train.scp

# create a 10k utt subset for global cmvn estimates,
head -n 10000 $dir/train.scp > $dir/train.scp.10k

# for debugging, add list with non-local features,
subtools/kaldi/utils/shuffle_list.pl --srand 777 <$data/feats.scp >$dir/train.scp_non_local
