...
def GetArgs():
    parser = argparse.ArgumentParser(
        ...
        epilog = "e.g. subtools/kaldi/steps/dict/internal/get_subsegments.py exp/tri3_lex_0.4_work/phonetic_decoding/word.ctm \\"
        ...
        "See subtools/kaldi/steps/dict/learn_lexicon_greedy.sh for an example.")
