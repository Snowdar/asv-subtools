...
def GetArgs():
    parser = argparse.ArgumentParser(
        ...
        "(output from subtools/kaldi/steps/cleanup/debug_lexicon.txt). The output contains accumulated soft-counts"
        "of pronunciations",
        epilog = "cat exp/tri3_lex_0.4_work/lats/arc_info_sym.*.txt \\|"
        "  subtools/kaldi/steps/dict/get_pron_stats.py - exp/tri3_lex_0.4_work/phone_decode/phone_map.txt \\"
        "  exp/tri3_lex_0.4_work/lats/pron_stats.txt"
        "See subtools/kaldi/steps/dict/learn_lexicon_greedy.sh for examples in detail.")
    ...
    parser.add_argument("phone_map", metavar = "<phone-map>", type = str,
                        ...
                        "generated in subtools/kaldi/steps/cleanup/debug_lexicon.sh")
