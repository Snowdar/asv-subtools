...
# It can be faster than subtools/kaldi/steps/get_ctm_conf.sh --use-segments false as it splits
...
if [ $# -ne 4 ]; then
  ...
  echo "See also: subtools/kaldi/steps/get_ctm.sh, subtools/kaldi/steps/get_ctm_conf.sh"
  exit 1;
fi
