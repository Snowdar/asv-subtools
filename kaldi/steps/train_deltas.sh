...
if [ $# != 6 ]; then
   echo "Usage: subtools/kaldi/steps/train_deltas.sh <num-leaves> <tot-gauss> <data-dir> <lang-dir> <alignment-dir> <exp-dir>"
   echo "e.g.: subtools/kaldi/steps/train_deltas.sh 2000 10000 data/train_si84_half data/lang exp/mono_ali exp/tri1"
...
subtools/kaldi/steps/diagnostic/analyze_alignments.sh --cmd "$cmd" $lang $dir

# Summarize warning messages...
subtools/kaldi/utils/summarize_warnings.pl  $dir/log

subtools/kaldi/steps/info/gmm_dir_info.pl $dir
