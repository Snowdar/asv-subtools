...
if [ $# != 3 ]; then
   ...
   echo "Usage: subtools/kaldi/steps/decode_lvtln.sh [options] <graph-dir> <data-dir> <decode-dir>"
   echo " e.g.: subtools/kaldi/steps/decode_lvtln.sh exp/tri2d/graph_tgpr data/test_dev93 exp/tri2d/decode_dev93_tgpr"
