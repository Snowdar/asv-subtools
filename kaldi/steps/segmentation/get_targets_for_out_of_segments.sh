...
# See the script subtools/kaldi/steps/segmentation/lats_to_targets.sh for details about the 
# targets matrix.
...
# script subtools/kaldi/steps/segmentation/merge_targets.sh.
...
if [ $# -ne 3 ]; then
  ...
  Usage: subtools/kaldi/steps/segmentation/get_targets_for_out_of_segments.sh <data-dir> <whole-data-dir> <targets-dir>
   e.g.: subtools/kaldi/steps/segmentation/get_targets_for_out_of_segments.sh \
...
subtools/kaldi/utils/data/get_utt2num_frames.sh $whole_data
cp $whole_data/utt2num_frames $dir/reco2num_frames

$cmd JOB=1:$nj $dir/log/get_default_targets.JOB.log \
  subtools/kaldi/steps/segmentation/internal/get_default_targets_for_out_of_segments.py \
