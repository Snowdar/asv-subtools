...
if [ $# -ne 4 ]; then
  ...
  Usage: subtools/kaldi/steps/segmentation/lats_to_targets.sh <data-dir> <lang> <lattice-dir> <targets-dir>"
  e.g.: subtools/kaldi/steps/segmentation/lats_to_targets.sh \
