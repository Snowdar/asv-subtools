...
if (@ARGV == 0) {
  print STDERR "Usage: subtools/kaldi/steps/info/nnet3_disc_dir_info.pl [--debug] <nnet3-disc-dir1> [<nnet3-disc-dir2> ... ]\n" .
               "e.g: subtools/kaldi/steps/info/nnet3_dir_info.pl exp/nnet3/tdnn_sp_smbr\n" .
