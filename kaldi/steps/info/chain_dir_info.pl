...
if (@ARGV == 0) {
  print STDERR "Usage: subtools/kaldi/steps/info/nnet3_dir_info.pl [--debug] <nnet3-dir1> [<nnet3-dir2> ... ]\n" .
               "e.g: subtools/kaldi/steps/info/nnet3_dir_info.pl exp/nnet3/tdnn_sp\n" .
