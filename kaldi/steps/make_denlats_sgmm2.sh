...
if [ $# != 4 ]; then
   echo "Usage: subtools/kaldi/steps/make_denlats_sgmm2.sh [options] <data-dir> <lang-dir> <src-dir|alidir> <exp-dir>"
   echo "  e.g.: subtools/kaldi/steps/make_denlats_sgmm2.sh data/train data/lang exp/sgmm4a_ali exp/sgmm4a_denlats"
...
if [ -s $dir/dengraph/HCLG.fst ] && [ $dir/dengraph/HCLG.fst -nt $srcdir/final.mdl ]; then
  ...
  subtools/kaldi/utils/mkgraph.sh $new_lang $alidir $dir/dengraph || exit 1;
fi
