...
if [ $# != 4 ]; then
   echo "Usage: subtools/kaldi/steps/decode_si_fromlats.sh [options] <data-dir> <lang> <old-decode-dir> <decode-dir>"
   echo "e.g.: subtools/kaldi/steps/decode_si_fromlats.sh data/test_dev93 data/lang_test_tg exp/tri2b/decode_tgpr_dev93 exp/tri2a/decode_tgpr_dev93_fromlats"
   echo ""
