...
def should_do_shrinkage(iter, model_file, shrink_saturation_threshold,
    ...
    if get_raw_nnet_from_am:
        output = common_lib.get_command_stdout(
            ...
            "subtools/kaldi/steps/nnet3/get_saturation.pl".format(model_file))
    else:
        output = common_lib.get_command_stdout(
...
class CommonParser(object):
    ...
    in subtools/kaldi/steps/nnet3/train*.py and subtools/kaldi/steps/nnet3/chain/train.py
    """
    ...
    def __init__(self,
        ...
        self.parser.add_argument("--egs.opts", type=str, dest='egs_opts',
                                 ...
                                 to subtools/kaldi/steps/nnet3/get_egs.sh script""")
