...
if [ $# -ne 3 ]; then
  echo "Usage: subtools/kaldi/steps/decode_sgmm2.sh [options] <graph-dir> <data-dir> <decode-dir>"
  echo " e.g.: subtools/kaldi/steps/decode_sgmm2.sh --transform-dir exp/tri3b/decode_dev93_tgpr \\"
