...
if [ $stage -le 0 ]; then
  $cmd JOB=1:$nj $dir/log/resegment.JOB.log \
    ...
    subtools/kaldi/utils/int2sym.pl -f 2- $lang/phones.txt \| \
    subtools/kaldi/utils/apply_map.pl -f 2- $dir/phone_map.txt \| \
    subtools/kaldi/utils/segmentation.pl $segmentation_opts \| \
...
if [ $stage -le 1 ]; then
  ...
  subtools/kaldi/utils/utt2spk_to_spk2utt.pl $data_out/utt2spk > $data_out/spk2utt || exit 1
