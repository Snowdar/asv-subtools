...
if [ $# != 4 ]; then
   echo "usage: subtools/kaldi/steps/align_basis_fmllr.sh <data-dir> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  subtools/kaldi/steps/align_basis_fmllr.sh data/train data/lang exp/tri4 exp/tri4_ali"
   echo "Note: <src-dir> should ideally have been trained by subtools/kaldi/steps/train_sat_basis.sh, or"
   echo "if a non-SAT system (not recommended), the basis should have been computed"
   echo "by subtools/kaldi/steps/get_fmllr_basis.sh."
