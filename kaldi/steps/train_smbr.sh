...
if [ $# -ne 5 ]; then
  echo "Usage: subtools/kaldi/steps/train_smbr.sh <data> <lang> <ali> <denlats> <exp>"
  echo " e.g.: subtools/kaldi/steps/train_smbr.sh data/train_si84 data/lang exp/tri2b_ali_si84 exp/tri2b_denlats_si84 exp/tri2b_smbr"
