...
if [ $# != 7 ]; then
  echo "Usage: subtools/kaldi/steps/train_sgmm2.sh <num-leaves> <num-substates> <data> <lang> <ali-dir> <ubm> <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/train_sgmm2.sh 5000 8000 data/train_si84 data/lang \\"
