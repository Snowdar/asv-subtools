...
if [ ! -z "$online_ivector_dir" ]; then
  ...
  feats="$feats paste-feats --length-tolerance=$ivector_period ark:- 'ark,s,cs:subtools/kaldi/utils/filter_scp.pl $sdata/JOB/utt2spk $online_ivector_dir/ivector_online.scp | subsample-feats --n=-$ivector_period scp:- ark:- | copy-matrix --scale=$ivector_scale ark:- ark:-|' ark:- |"
fi
