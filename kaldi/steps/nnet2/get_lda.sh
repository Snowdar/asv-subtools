...
if [ $# != 4 ]; then
  echo "Usage: subtools/kaldi/steps/nnet2/get_lda.sh [opts] <data> <lang> <ali-dir> <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/nnet2/get_lda.sh data/train data/lang exp/tri3_ali exp/tri4_nnet"
  ...
  echo "                                                   # subtools/kaldi/steps/online/nnet2/extract_ivectors_online.sh"
  exit 1;
fi
...
case $feat_type in
  raw) feats="ark,s,cs:subtools/kaldi/utils/subset_scp.pl --quiet $N $sdata/JOB/feats.scp | apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:- ark:- |"
  ...
  lda) 
    ...
    cmvn_opts=$(cat $dir/cmvn_opts)
     feats="ark,s,cs:subtools/kaldi/utils/subset_scp.pl --quiet $N $sdata/JOB/feats.scp | apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:- ark:- | splice-feats $splice_opts ark:- ark:- | transform-feats $dir/final.mat ark:- ark:- |"
    ;;
...
if [ ! -z "$online_ivector_dir" ]; then
  ...
  spliced_feats="$spliced_feats paste-feats --length-tolerance=$ivector_period ark:- 'ark,s,cs:subtools/kaldi/utils/filter_scp.pl $sdata/JOB/utt2spk $online_ivector_dir/ivector_online.scp | subsample-feats --n=-$ivector_period scp:- ark:- | ivector-randomize --randomize-prob=$ivector_randomize_prob ark:- ark:- |' ark:- |"
