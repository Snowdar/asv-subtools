...
# subtools/kaldi/steps/online/nnet2/dump_nnet_activations.sh to dump activations of the last
# hidden layer of that network on our data, and then subtools/kaldi/steps/nnet2/retrain_fast.sh
...
dir_as_given=$dir
dir=$(subtools/kaldi/utils/make_absolute.sh $dir) # Convert $dir to an absolute pathname, so that the
