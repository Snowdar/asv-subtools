...
if [ $# != 2 ]; then
  echo "Usage: subtools/kaldi/steps/nnet2/get_pca_transform.sh [options] <data> <dir>"
  echo " e.g.: subtools/kaldi/steps/train_pca_transform.sh data/train_si84 exp/tri2b"
...
feats="ark,s,cs:subtools/kaldi/utils/subset_scp.pl --quiet $max_utts $data/feats.scp | apply-cmvn-online $online_cmvn_opts $dir/global_cmvn.stats scp:- ark:- | splice-feats $splice_opts ark:- ark:- | subsample-feats --n=$subsample ark:- ark:- |"
