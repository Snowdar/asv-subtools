...
if [ $stage -le 2 ]; then
  ...
  # The next line is a no-op unless $dir/feats/storage/ exists; see subtools/kaldi/utils/create_split_dir.pl.
  for j in $(seq $nj); do  subtools/kaldi/utils/create_data_link.pl $dir/feats/feats.$j.ark; done
...
if [ $stage -le 4 ]; then
  ...
  subtools/kaldi/steps/compute_cmvn_stats.sh --fake $dir/data $dir/log $dir/feats || exit 1
fi
