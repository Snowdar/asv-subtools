...
if [ $# != 4 ]; then
  echo "Usage: subtools/kaldi/steps/online/nnet2/get_egs.sh [opts] <data> <ali-dir> <online-nnet-dir> <exp-dir>"
  echo " e.g.: subtools/kaldi/steps/online/nnet2/get_egs.sh data/train exp/tri3_ali exp/nnet2_online/nnet_a_gpu_online/ exp/tri4_nnet"
...
if [ -f $data/utt2uniq ]; then
  ...
  cat $dir/valid/uttlist.tmp | subtools/kaldi/utils/apply_map.pl $data/utt2uniq | \
...
awk '{print $1}' $data/utt2spk | subtools/kaldi/utils/filter_scp.pl --exclude $dir/valid/uttlist | \
   subtools/kaldi/utils/shuffle_list.pl | head -$num_utts_subset > $dir/train_subset/uttlist || exit 1;
...
for subdir in valid train_subset; do
  ...
  subtools/kaldi/utils/filter_scp.pl $dir/$subdir/uttlist <$data/utt2spk | awk '{print $2}' > $dir/$subdir/spklist || exit 1;
  subtools/kaldi/utils/filter_scp.pl -f 2 $dir/$subdir/spklist <$data/utt2spk >$dir/$subdir/utt2spk || exit 1;
  subtools/kaldi/utils/utt2spk_to_spk2utt.pl <$dir/$subdir/utt2spk >$dir/$subdir/spk2utt || exit 1;
...
if [ -f $data/segments ]; then
  ...
  valid_feats="ark,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/valid/uttlist_extended $data/segments  | extract-segments scp:$data/wav.scp - ark:- | online2-wav-dump-features --config=$dir/feature.conf ark:$dir/valid/spk2utt ark,s,cs:- ark:- | subset-feats --include=$dir/valid/uttlist ark:- ark:- |"
  train_subset_feats="ark,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/train_subset/uttlist_extended $data/segments  | extract-segments scp:$data/wav.scp - ark:- | online2-wav-dump-features --config=$dir/feature.conf ark:$dir/train_subset/spk2utt ark,s,cs:- ark:- | subset-feats --include=$dir/train_subset/uttlist ark:- ark:- |"
else
  ...
  valid_feats="ark,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/valid/uttlist_extended $data/wav.scp | online2-wav-dump-features --config=$dir/feature.conf ark:$dir/valid/spk2utt scp:- ark:- | subset-feats --include=$dir/valid/uttlist ark:- ark:- |"
  train_subset_feats="ark,s,cs:subtools/kaldi/utils/filter_scp.pl $dir/train_subset/uttlist_extended $data/wav.scp | online2-wav-dump-features --config=$dir/feature.conf ark:$dir/train_subset/spk2utt scp:- ark:- | subset-feats --include=$dir/train_subset/uttlist ark:- ark:- |"
fi
...
if [ $stage -le 2 ]; then
  ...
  for id in $(seq $nj); do gunzip -c $alidir/ali.$id.gz; done | \
    ...
    subtools/kaldi/utils/filter_scp.pl <(cat $dir/valid/uttlist $dir/train_subset/uttlist) | \
