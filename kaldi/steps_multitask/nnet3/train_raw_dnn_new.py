...
""" This script is similar to subtools/kaldi/steps_multitask/nnet3/train_dnn.py but trains a
...
def get_args():
    ...
    # General options
    parser.add_argument("--exit-stage", type=int, default=10000000,
                        help="Exit stage")
...
def process_args(args):
    ...
    if (not os.path.exists(args.dir)
        ...
        raise Exception("This scripts expects {0} to exist.  Also either "
...
def train(args, run_opts):
    ...
    # transform.
    if ((args.stage <= -5) and 
        (os.path.exists(args.dir+"/configs/init.config")) and
