...
if [[ ( $# -lt 5 ) || ( $# -gt 7 ) ]]; then
   echo "usage: subtools/kaldi/steps_multitask/nnet3/make_bottleneck_features.sh <bnf-node-name> <input-data-dir> <bnf-data-dir> <nnet-dir> <nnet-mdl> [<log-dir> [<bnfdir>] ]"
...
ivector_feats="scp:subtools/kaldi/utils/filter_scp.pl $sdata/utt2spk $ivector_dir/ivector_online.scp |"
