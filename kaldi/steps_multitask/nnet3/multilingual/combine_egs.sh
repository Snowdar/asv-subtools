...
if [ $stage -le 0 ]; then
  ...
  subtools/kaldi/steps_multitask/nnet3/multilingual/allocate_multilingual_examples.py $egs_opt \
...
if [ $stage -le 1 ]; then
  ...
  subtools/kaldi/steps_multitask/nnet3/multilingual/allocate_multilingual_examples.py \
      --random-lang false \
