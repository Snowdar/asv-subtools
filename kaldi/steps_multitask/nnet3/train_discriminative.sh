...
# using egs obtained by subtools/kaldi/steps_multitask/nnet3/get_egs_discriminative.sh
...
while [ $x -lt $num_iters ]; do
  ...
  if [ $stage -le $x ] && [ ! -z "${iter_to_epoch[$x]}" ]; then
    ...
    (
      ...
      subtools/kaldi/steps_multitask/nnet3/adjust_priors.sh --egs-type degs \
