...
# 'subtools/kaldi/utils/gen_topo.pl' that generates a different type of topology, one that we
...
if (@ARGV != 2) {
  print STDERR "Usage: subtools/kaldi/utils/gen_topo.pl <colon-separated-nonsilence-phones> <colon-separated-silence-phones>\n";
  print STDERR "e.g.:  subtools/kaldi/utils/gen_topo.pl 4:5:6:7:8:9:10 1:2:3\n";
  exit (1);
}
