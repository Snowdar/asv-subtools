...
""" This script is based on subtools/kaldi/steps_multitask/nnet3/lstm/train.sh
"""
...
def get_args():
    ...
    parser.add_argument("--trainer.optimization.shrink-saturation-threshold",
                        ...
                        subtools/kaldi/steps_multitask/nnet3/get_saturation.pl) exceeds this threshold
