...
def get_args():
    ...
    parser.add_argument('--left-context', required=True,
                        help='The left context of the network')
    parser.add_argument('--right-context', required=True,
                        help='The right context of the network')
...
def add_nnet_context_info_multi_input(config_dir, nnet_edits=None,
                          existing_model=None, left_context=None, right_context=None):
...
def main():
    ...
    add_nnet_context_info_multi_input(args.config_dir, args.nnet_edits,
                          existing_model=args.existing_model,
