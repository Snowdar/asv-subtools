...
# This script is similar to subtools/kaldi/steps_multitask/nnet3/get_egs.sh but used
...
awk '{print $1}' $data/utt2spk | subtools/kaldi/utils/shuffle_list.pl | head -$num_utts_subset_valid | sort \
...
awk '{print $1}' $data/utt2spk | subtools/kaldi/utils/filter_scp.pl --exclude $dir/valid_uttlist | \
   subtools/kaldi/utils/shuffle_list.pl | head -$num_utts_subset_train | sort > $dir/train_subset_uttlist || exit 1;
