...
def generate_egs_using_targets(data, targets_scp, egs_dir,
                               ...
                               transform_dir=None):
    """ Wrapper for calling subtools/kaldi/steps_multitask/nnet3/get_egs_targets.sh
    ...
    Args:
        ...
        For other options, see the file subtools/kaldi/steps_multitask/nnet3/get_egs_targets.sh
    """
    ...
    common_lib.execute_command(
        """subtools/kaldi/steps_multitask/nnet3/get_egs_targets.sh {egs_opts} \
                --cmd "{command}" \
                --cmvn-opts "{cmvn_opts}" \
