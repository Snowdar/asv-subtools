...
## Set up features.
feats="ark,s,cs:add-deltas $delta_opts scp:$sdata/feats.scp ark:- | apply-cmvn-sliding --norm-vars=true --center=true --cmn-window=300 ark:- ark:- | select-voiced-frames ark:- scp,s,cs:$sdata/vad.scp ark:- |"
