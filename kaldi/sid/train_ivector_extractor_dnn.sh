...
# an fGMM, usually created by the script subtools/sid/init_full_gmm_from_dnn.sh.
...
subtools/kaldi/utils/split_data.sh $data $nj_full || exit 1;

sdata_dnn=$data_dnn/split$nj_full;
subtools/kaldi/utils/split_data.sh $data_dnn $nj_full || exit 1;
