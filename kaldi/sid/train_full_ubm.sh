...
if [ $# != 3 ]; then
  echo "Usage: subtools/kaldi/steps/train_full_ubm.sh <data> <old-ubm-dir> <new-ubm-dir>"
  echo "Trains a full-covariance UBM starting from an existing diagonal or"
  echo "full-covariance UBM system."
  echo " e.g.: subtools/kaldi/steps/train_full_ubm.sh --num-iters 8 data/train exp/diag_ubm exp/full_ubm"
