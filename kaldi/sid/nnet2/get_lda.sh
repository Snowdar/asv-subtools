...
# Apache 2.0.
#
# This script is based off of get_lda.sh in ../../subtools/kaldi/steps/nnet2/, but has been
...
case $feat_type in
  raw) feats="ark,s,cs:subtools/kaldi/utils/subset_scp.pl --quiet $N $sdata/JOB/feats.scp | apply-cmvn-sliding --center=true scp:- ark:- |"
   ;;
  lda)
    splice_opts=`cat $alidir/splice_opts 2>/dev/null`
    cp $alidir/{splice_opts,final.mat} $dir || exit 1;
     feats="ark,s,cs:subtools/kaldi/utils/subset_scp.pl --quiet $N $sdata/JOB/feats.scp | apply-cmvn-sliding --center=true scp:- ark:- | splice-feats $splice_opts ark:- ark:- | transform-feats $dir/final.mat ark:- ark:- |"
    ;;
