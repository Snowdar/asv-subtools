...
if [ $# -ne 4 ] && [ $# -ne 3 ]; then
  ...
  echo "E.g.: subtools/kaldi/utils/format_lm_sri.sh data/lang data/local/lm/foo.kn.gz data/local/dict/lexicon.txt data/lang_test"
  ...
  echo "that doesn't require SRILM: see subtools/kaldi/utils/format_lm.sh"
  echo "options:"
