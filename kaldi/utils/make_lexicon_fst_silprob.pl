...
# subtools/kaldi/utils/lang/make_lexicon_fst_silprob.py which is the python-based replacement.
...
if (@ARGV != 4) {
  ...
  print STDERR "\n";
  print STDERR "This script is almost the same as the subtools/kaldi/utils/make_lexicon_fst.pl\n";
  ...
  print STDERR "Other files are the same as subtools/kaldi/utils/make_lexicon_fst.pl\n";
