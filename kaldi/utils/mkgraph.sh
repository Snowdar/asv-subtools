...
if [ $# != 3 ]; then
   echo "Usage: subtools/kaldi/utils/mkgraph.sh [options] <lang-dir> <model-dir> <graphdir>"
   echo "e.g.: subtools/kaldi/utils/mkgraph.sh data/lang_test exp/tri1/ exp/tri1/graph"
   echo " Options:"
