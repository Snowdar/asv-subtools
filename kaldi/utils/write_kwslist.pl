...
Usage: subtools/kaldi/utils/write_kwslist.pl [options] <raw_result_in|-> <kwslist_out|->
 e.g.: subtools/kaldi/utils/write_kwslist.pl --flen=0.01 --duration=1000 --segments=data/eval/segments
