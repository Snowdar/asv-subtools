...
Usage: subtools/kaldi/utils/map_arpa_lm.pl [options] <vocab-file> < input-arpa >output-arpa
 e.g.: subtools/kaldi/utils/map_arpa_lm.pl words.txt <arpa_lm.txt >arpa_lm.int
