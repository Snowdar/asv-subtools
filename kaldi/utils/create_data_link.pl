...
# links. It is supposed to use together with subtools/kaldi/utils/create_split_dir.pl, which
...
Usage: subtools/kaldi/utils/create_data_link.pl <data-archive1> [<data-archive2> ... ]
 e.g.: subtools/kaldi/utils/create_data_link.pl foo/bar/egs.3.4.ark foo/bar/egs.3.5.ark
 (note: the dirname, e.g. foo/bar/, must be the same in all cases).

See also subtools/kaldi/utils/remove_data_links.sh
EOU
...
# subtools/kaldi/utils/create_data_link.pl subtools/kaldi/utils/create_data_link.pl foo/1.3.ark  foo/2.3.ark
# ls -l foo
# total 0
