...
#
# The data structure is based on: kaldi/egs/wsj/s5/subtools/kaldi/utils/lang/make_phone_lm.py
...
default_encoding = "latin-1"  # For encoding-agnostic scripts, we assume byte stream as input.
                              ...
                              # Ref: kaldi/egs/wsj/s5/subtools/kaldi/utils/lang/bpe/prepend_words.py @ 69cd717
strip_chars = " \t\r\n"
