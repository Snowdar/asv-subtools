...
def ReadBigramMap(bigrams_file):
    ...
    try:
        ...
        sys.exit("subtools/kaldi/utils/lang/internal/arpa2fst_constrained.py: error opening "
    ...
    while True:
        ...
        a = line.split()
        if len(a) != 2:
            sys.exit("subtools/kaldi/utils/lang/internal/arpa2fst_constrained.py: bad line in "
