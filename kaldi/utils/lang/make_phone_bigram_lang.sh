...
# language-id.
#
#  See also subtools/kaldi/steps/make_phone_graph.sh
...
subtools/kaldi/utils/sym2int.pl $lang_out/phones.txt <$lang_out/phones/align_lexicon.txt >$lang_out/phones/align_lexicon.int

# L and L_disambig are the same.
cp $lang_out/L.fst $lang_out/L_disambig.fst

subtools/kaldi/utils/validate_lang.pl --skip-disambig-check $lang_out || exit 1;
