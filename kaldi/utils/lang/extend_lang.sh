...
if [ $# -ne 3 ]; then
  echo "Usage: subtools/kaldi/utils/extend_lang.sh <old-lang-dir> <lexicon> <new-lang-dir>"
  echo "e.g.: subtools/kaldi/utils/extend_lang.sh data/lang data/local/dict_new_words/lexiconp.txt data/lang_new_words"
  echo ""
...
if ! subtools/kaldi/utils/sym2int.pl -f 3- $srcdir/phones.txt $tmpdir/lexiconp.txt >/dev/null; then
  echo "$0: it looks like there are unseen phones in your lexicon $lexicon"
  exit 1
fi

ndisambig=$(subtools/kaldi/utils/add_lex_disambig.pl --pron-probs $tmpdir/lexiconp.txt $tmpdir/lexiconp_disambig.txt)
...
subtools/kaldi/utils/sym2int.pl $dir/phones.txt <$dir/phones/disambig.txt >$dir/phones/disambig.int
subtools/kaldi/utils/sym2int.pl $dir/phones.txt <$dir/phones/disambig.txt | \
...
cat $dir/phones/align_lexicon.txt | subtools/kaldi/utils/sym2int.pl -f 3- $dir/phones.txt | \
  subtools/kaldi/utils/sym2int.pl -f 1-2 $dir/words.txt > $dir/phones/align_lexicon.int

# Create the basic L.fst without disambiguation symbols, for use
# in training.

subtools/kaldi/utils/lang/make_lexicon_fst.py $grammar_opts --sil-prob=$sil_prob --sil-phone=$silphone \
         $tmpdir/lexiconp.txt | \
...
subtools/kaldi/utils/lang/make_lexicon_fst.py $grammar_opts \
...
! subtools/kaldi/utils/validate_lang.pl --skip-generate-words-check $dir && echo "$(basename $0): error validating output" &&  exit 1;
