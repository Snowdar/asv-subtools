...
if [ $# -ne 2 ]; then
  echo "Usage: subtools/kaldi/utils/lang/check_phones_compatible.sh <phones-symbol-table1> <phones-symbol-table2>"
  echo "e.g.: subtools/kaldi/utils/lang/check_phones_compatible.sh data/lang/phones.txt exp/tri3/phones.txt"
  exit 1;
fi
