...
if [ ! -f $data/segments ]; then
  ...
  subtools/kaldi/utils/copy_data_dir.sh $data $dir
  exit 0
fi
...
subtools/kaldi/utils/data/internal/combine_segments_to_recording.py \
  --write-reco2utt=$dir/reco2sorted_utts $data/segments $dir/utt2spk || exit 1

if [ -f $data/text ]; then
  subtools/kaldi/utils/apply_map.pl -f 2- $data/text < $dir/reco2sorted_utts > $dir/text || exit 1
fi

rm $dir/reco2sorted_utts

subtools/kaldi/utils/fix_data_dir.sh $dir || exit 1
