...
# Testing
# echo foo |  subtools/kaldi/utils/data/normalize_data_range.pl -> foo
# echo 'foo[bar:baz]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> foo[bar:baz]
# echo 'foo[bar:baz][bin:bang]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> normalize_data_range.pl: could not make sense of input line foo[bar:baz][bin:bang]
# echo 'foo[10:20][0:5]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> foo[10:15]
# echo 'foo[,10:20][,0:5]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> foo[,10:15]
# echo 'foo[,0:100][1:15]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> foo[1:15,0:100]
# echo 'foo[1:15][,0:100]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> foo[1:15,0:100]
# echo 'foo[10:20][0:11]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> normalize_data_range.pl: could not make sense of line foo[10:20][0:11] [second row range too large vs first range, 10 + 11 > 20]
# echo 'foo[,10:20][,0:11]' |  subtools/kaldi/utils/data/normalize_data_range.pl -> normalize_data_range.pl: could not make sense of line foo[,10:20][,0:11] [second column range too large vs first range, 10 + 11 > 20]
