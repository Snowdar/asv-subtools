...
if ! subtools/kaldi/utils/validate_data_dir.sh $srcdir; then
  echo "$0: failed to validate input directory $srcdir.  If needed, run   subtools/kaldi/utils/fix_data_dir.sh $srcdir"
  exit 1
fi
...
subtools/kaldi/utils/data/internal/choose_utts_to_combine.py --min-duration=$min_seg_len \
...
# the subtools/kaldi/utils/apply_map.pl will create a line that looks like
...
subtools/kaldi/utils/apply_map.pl -f 2- $srcdir/feats.scp <$dir/utt2utts | \
...
# utts.
subtools/kaldi/utils/apply_map.pl -f 2- $srcdir/text <$dir/utt2utts > $dir/text
...
if [ -f $srcdir/utt2uniq ]; then
  ...
  awk '{$1 = ""; print;}' < $dir/utt2utts | \
    subtools/kaldi/utils/apply_map.pl $srcdir/utt2uniq > $dir/uniq_sets
...
' > $dir/uniq_to_orig_uniq
  ...
  awk '{print $1, $2}' < $dir/utt2utts | subtools/kaldi/utils/apply_map.pl -f 2 $srcdir/utt2uniq | \
    subtools/kaldi/utils/apply_map.pl -f 2 $dir/uniq_to_orig_uniq > $dir/utt2uniq
...
subtools/kaldi/utils/validate_data_dir.sh --no-wav $dir
