...
if $position_dependent_phones; then
  ...
  if "$silprob"; then
    ...
    subtools/kaldi/utils/lang/make_position_dependent_subword_lexicon.py $srcdir/lexiconp.txt > $tmpdir/lexiconp.txt || exit 1;
  fi
...
#  # and where it's called in the example scripts (run.sh).
  ...
  subtools/kaldi/utils/lang/make_subword_lexicon_fst.py $grammar_opts --sil-prob=$sil_prob --sil-phone=$silphone --position-dependent\
...
if [ -f $dir/phones/word_boundary_moved.txt ]; then
  subtools/kaldi/utils/sym2int.pl -f 1 $dir/phones.txt <$dir/phones/word_boundary_moved.txt \
...
if $silprob; then
  ...
  subtools/kaldi/utils/lang/make_subword_lexicon_fst.py $grammar_opts \
