...
# ../subtools/kaldi/steps/resegment_data.sh), followed by ali-to-phones --per-frame=true and
...
if (@ARGV != 0) {
  print STDERR "$0:\n" .
               ...
               "This program is called from subtools/kaldi/steps/resegment_data.sh.  Please see\n" .
