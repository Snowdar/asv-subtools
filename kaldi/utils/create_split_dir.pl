...
#
#   subtools/kaldi/utils/create_split_dir.pl /export/gpu-0{3,4,5}/egs/storage egs/storage
#
...
Usage: subtools/kaldi/utils/create_split_dir.pl <actual_storage_dirs> <pseudo_storage_dir>
 e.g.: subtools/kaldi/utils/create_split_dir.pl /export/gpu-0{3,4,5}/egs/storage egs/storage
