...
import libs.egs.egs_multi_task as egs_multi_task #Zheng Li 2020-10
import libs.training.optim as optim
import libs.training.lr_scheduler as learn_rate_scheduler
import libs.training.trainer_new as trainer #Zheng Li 2020-10
...
model_params = {
    "extend":False, "SE":False, "se_ratio":4, "training":True, "extracted_embedding":"far","mt_alpha":0.2,
...
##--------------------------------------------------##
## Main params
traindata="data/voxceleb1_train_aug"
egs_dir="/data2/lz/egs/multi_task_mfcc_23_pitch_voxceleb1_train_aug_fix" + "_" + sample_type

model_blueprint = "subtools/pytorch/model/multi-task-xvector-fix.py"
model_dir = "exp/multi_task_voxceleb1"

ali_dir="exp/ali_voxceleb1_train_aug"  # the direction of alignment files, Zheng Li 2020-10
subsampling="false" # str, If the chain alignment was uesed, you should turn subsampling = true, Zheng Li 2020-10
##--------------------------------------------------##
##
######################################################### START #########################################################
##
...
if stage <= 3 <= endstage:
    ...
    model = model_py.Xvector(info["feat_dim"], info["num_targets"], info["num_phones"], **model_params) #Zheng Li 2020-10
    ...
    trainer = trainer.MultitaskTrainer(package) #Zheng Li 2020-10
