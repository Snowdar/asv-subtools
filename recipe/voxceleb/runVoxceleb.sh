...
# voxceleb_all_train = voxceleb1_train + voxceleb2_train (without test part both)
subtools/kaldi/utils/combine_data.sh data/voxceleb_all_train data/voxceleb1_train data/voxceleb2_train

# Get the copies of dataset which is labeled by a prefix like mfcc_23_pitch or fbank_40 etc.
subtools/newCopyData.sh mfcc_23_pitch "voxceleb_all_train voxceleb1_test"
...
subtools/augmentDataByNoise.sh --rirs-noises /data/ASV/SRE19/RIRS_NOISES/ --musan /data/ASV/SRE19/musan --factor 1 \
                                data/mfcc_23_pitch/voxceleb_all_train/ data/mfcc_23_pitch/voxceleb_all_train_aug
# Make features for trainset
subtools/makeFeatures.sh --pitch true --pitch-config subtools/conf/pitch.conf data/mfcc_23_pitch/voxceleb_all_train_aug/ mfcc \
                                subtools/conf/sre-mfcc-23.conf
# Compute VAD for augmented trainset
subtools/computeAugmentedVad.sh  data/mfcc_23_pitch/voxceleb_all_train_aug data/mfcc_23_pitch/voxceleb_all_train/utt2spk \
                                 subtools/conf/vad-5.5.conf

# Get a copy of voxceleb1_train_aug by spliting from voxceleb_all_train_aug
subtools/filterDataDir.sh --split-aug true data/mfcc_23_pitch/voxceleb_all_train_aug/ data/voxceleb1_train/utt2spk \
                                data/mfcc_23_pitch/voxceleb1_train_aug

# Get a copy of clean dataset for scoring by spliting from voxceleb_all_train_aug
subtools/filterDataDir.sh --check false --split-aug false data/mfcc_23_pitch/voxceleb_all_train_aug/ data/voxceleb_all_train/utt2spk \
                                data/mfcc_23_pitch/voxceleb_all_train

subtools/filterDataDir.sh --split-aug false data/mfcc_23_pitch/voxceleb_all_train_aug/ data/voxceleb1_train/utt2spk \
                                data/mfcc_23_pitch/voxceleb1_train

subtools/filterDataDir.sh --split-aug false data/mfcc_23_pitch/voxceleb_all_train_aug/ data/voxceleb2_train/utt2spk \
...
# Training with voxceleb_all_train_aug
