...
##--------------------------------------------------##
## Main params
traindata="data/mfcc_20_5.0/train_aug" #the data_dir where contains feats.scp, utt2spk .etc files.
...
if stage <= 4 <= endstage and utils.is_main_training():
    ...
    # data/ap20-olr/train_concat_volume_sp
    ...
    to_extracted_data = ["train"] # All dataset should be in data_root/prefix.
