...
prefix=mfcc_20_5.0 # if NULL, datadir will be data/$someset rather than data/$prefix/$someset.
...
force_clear=false # if NULL, the follows could be set up separately
...
for the_classfier in $(echo $score | sed 's/-/ /g');do
    ...
    for the_metric in $(echo $metric | sed 's/-/ /g');do
        ...
        [ "$the_metric" == "Cavg" ] && python2 subtools/computeCavg.py -pairs $trials ${outname}.score > ${outname}.Cavg && \
