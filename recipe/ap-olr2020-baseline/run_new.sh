...
# Update info: For open-set dialect identification task, a new script named computeCavg_unknown.py was provided to compute Cavg and it will be used in the final test procedure.
#
...
for exp in exp/pytorch_xvector/far_epoch21 exp/pytorch_xvector/far_epoch21 exp/kaldi_xvector/embedding1 exp/kaldi_ivector;do
  ...
  subtools/scoreSets_new.sh --eval false --vectordir $exp --prefix mfcc_20_5.0  --enrollset=task1_enroll --testset=task1_test \
