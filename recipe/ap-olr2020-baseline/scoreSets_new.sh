...
for the_classfier in $(echo $score | sed 's/-/ /g');do
    ...
    for the_metric in $(echo $metric | sed 's/-/ /g');do
        ...
        [ "$the_metric" == "Cavg" && "$open-set-test" == "false" ] && subtools/computeCavg.py -pairs $trials ${outname}.score > ${outname}.Cavg && \
        [ "$the_metric" == "Cavg" && "$open-set-test" == "true" ] && subtools/computeCavg_unknown.py -pairs $trials ${outname}.score > ${outname}.Cavg && \
